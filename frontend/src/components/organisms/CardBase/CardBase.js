  ...
  return (
    <Card
      className={clsx(
        ...
        light ? classes.transparentBgLight : {},
    ...
    >
      <CardContent
        className={clsx('card-base__content', thinner ? classes.contentThin : classes.content, classes[align])}
        {...cardContentProps}
      >
        {children}
      </CardContent>
